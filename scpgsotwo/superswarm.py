...
#        print(f'{self.num_dimensions}')
#        exit()
        for i in range(0,self.num_dimensions):
#            self.personal_best_particle.append(random.uniform(min,max))
#            self.velocity_i.append(random.uniform(min,max))
...
#            print(f'uvlt {np.array(self.personal_best_particle).shape}')
#            exit()
